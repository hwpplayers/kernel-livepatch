...
static struct vxlan_dev *(*klpe_vxlan_vs_find_vni)(struct vxlan_sock *vs, __be32 vni);
					...
					u32 flags)
{
	...
	return (*klpe_vxlan_vs_find_vni)(vs, vni);
}
...
static struct klp_kallsyms_reloc klp_funcs[] = {
	...
	{ "vxlan_vs_find_vni", (void *)&klpe_vxlan_vs_find_vni, "vxlan" },
