...
static void (*klp_pipe_buf_mark_unmergeable)(struct pipe_buffer *buf);
...
static struct klp_kallsyms_reloc klp_funcs[] = {
	...
	{ "pipe_buf_mark_unmergeable", (void *)&klp_pipe_buf_mark_unmergeable },
};
	...
	do {
		...
		if (len >= ibuf->len) {
			...
			*obuf = *ibuf;
			...
			klp_pipe_buf_mark_unmergeable(obuf);
